 ...
 * </table>
 * <p>
 * You may also append {@code "-JMetal"} to any algorithm name to use the JMetal
 * implementation incase it is overridden by another implementation. For
 * example, use {@code "NSGAII-JMetal"}.
 * <p>
 * Unless the type is marked with *, the algorithm uses one of the types listed
 * below. Note that only the types below are supported. Algorithms marked with *
 * define operators specific to that algorithm. See the JMetal documentation for
 * additional details.
 * <p>
 * <table width="100%" border="1" cellpadding="3" cellspacing="0">
 * <tr class="TableHeadingColor">
