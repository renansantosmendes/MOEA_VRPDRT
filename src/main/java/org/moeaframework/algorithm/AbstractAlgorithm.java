...
public abstract class AbstractAlgorithm implements AlgorithmMOEA {
     ...
     * prefer calling this method over {@code evaluate} whenever possible, as
     * this ensures the solutions can be evaluated in parallel.
     *
    ...
    /**
     * Performs one iteration of the algorithm. This method should be overridden
     * by implementations to perform each logical iteration of the algorithm.
     */
     ...
     * invoked during finalization, and need only be called directly if non-Java
