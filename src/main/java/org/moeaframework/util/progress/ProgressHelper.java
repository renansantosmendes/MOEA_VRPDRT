...
public class ProgressHelper {
     ...
     */
    private AlgorithmMOEA currentAlgorithm;
    ...
    /**
     * Constructs a new progress helper for generating progress reports for the
     * given executor.
     *
     ...
     * {@code isSeedFinished} to indicate that a seed has completed and results
     * can be accessed from the executor.
     *
    ...
    /**
     * Sets the current seed. This call will have no affect if the current seed
     * is unchanged. This method will generate a progress report if the current
     * seed changes.
     * <p>
     * <b>It is strongly recommended that {@link #nextSeed()} is used instead of
     * this method, as {@code nextSeed()} sets the current NFE to 0.</b>
     *
    ...
    /**
     * Sets the currently running algorithm, so that {@link ProgressEvent}s can
     * access the algorithm object.
     *
     * @param algorithm - the algorithm that is going to be running
     */
    public void setCurrentAlgorithm(AlgorithmMOEA algorithm) {
        this.currentAlgorithm = algorithm;

    }

    /**
     * Increments the current seed and sets NFE to 0. This method will generate
     * a progress report. This method should be invoked after every seed
     * completes in order to notify listeners that the seed completed.
     */
    ...
    /**
     * Prepares this progress helper for use. This method must be invoked prior
     * to calling all other methods. The internal state of the progress helper
     * is reset, allowing a single progress helper to be reused across many
     * sequential runs.
     *
