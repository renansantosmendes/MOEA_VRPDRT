...
class ProblemBuilder {
    ...
    /**
     * The arguments used when constructing an instance of the problem class. If
     * {@code null}, then the nullary (empty) constructor is used.
     */
    Object[] problemArguments;

    /**
     * The problem provider for creating problem instances; or {@code null} if
     * the default problem factory should be used.
     */
    ...
    /**
     * Sets the file containing the reference set to be used by this builder. If
     * not specified, the reference set should be aggregated from all individual
     * approximation sets.
     *
     ...
     * <ol>
     * <li>If {@link #withReferenceSet(File)} has been set, the contents of the
     * reference set file are returned;
     * <li>If the problem factory provides a reference set via the
     * {@link ProblemFactory#getReferenceSet(String)} method, this reference set
     * is returned;
    ...
    /**
     * Returns a new instance of the problem used by this builder, or throws an
     * exception if no problem has been defined. The code requesting the problem
     * instance is expected to close the problem when finished.
     *
     * @return a new instance of the problem used by this builder, or throws an
     * exception if no problem has been defined
     ...
     *         {@link InvocationTargetException} or {@link NoSuchMethodException}.
     */
